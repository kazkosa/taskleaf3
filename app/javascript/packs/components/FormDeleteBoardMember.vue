  ...
  <transition name="modal">
    <div v-if="isShow" id="modal_m1-01" class="modal js-modal" key="modal1">
      ...
      <div class="modal__content modal__content-project-form">
        ...
        <h4 class="modal_title"><span>Delete {{user.name}} from {{board.name}}</span></h4>
        <p class="modal_message">Are you sure you want to delete this member?</p>
        <button @click="deleteBoardMember" class="btnSubmit">Yes</button>
...
export default {
  ...
  methods: {
    ...
    deleteBoardMember: function() {
      axios.delete('/api/board_members/' + this.user.id )
      .then((res) => {
