  ...
  <transition name="modal">
    <div v-if="isShow" id="modal_m1-01" class="modal js-modal" key="modal1">
      ...
      <div class="modal__content modal__content-project-form">
        ...
        <h4 class="modal_title"><span>Delete Status "{{state.name}}"</span></h4>
        <p class="modal_message">Are you sure you want to delete this status?</p>
        <button @click="deleteStateData" class="btnSubmit">Yes</button>
...
export default {
  ...
  methods: {
    ...
    deleteStateData: function() {
       axios.delete('/api/states/' + this.stateId)
        .then((res) => {
          // console.log(res)
